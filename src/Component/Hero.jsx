...
import { robot, discount } from "../images/main";
    ...
    >
      ...
      >
        <div className="flex flex-row items-center bg-discount-gradient rounded-[10px] mb-2 py-[6px] px-4">
          <img src={discount} alt="img" className="w-[32px] h-[32px]" />
          <p className={`${styles.paragraph} ml-2`}>
            <span className="text-white mr-1">20%</span>
            Discount For
            <span className="text-white mr-1 ml-1">1 Month</span>
            Account
          </p>
        </div>
      ...
      <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
        <img src={robot} alt="img" className="w-[100%] h-[100%] relative z-[5]" />
